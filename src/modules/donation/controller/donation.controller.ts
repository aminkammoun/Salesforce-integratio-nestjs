...
export class DonationController {
    ...
    async enterCash(@Param('campaignId') campaignId: string, @Body() body: { amount: number, bankcheck: number }) {
        return this.donationService.enterCash(campaignId, body.amount, body.bankcheck);
    }
}
